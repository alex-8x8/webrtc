...
- (void)testAudioVolumeDidNotify {
  ...
  RTC_OBJC_TYPE(RTCAudioSession) *session = [[RTC_OBJC_TYPE(RTCAudioSession) alloc] initWithAudioSession:[[RTC_OBJC_TYPE(RTCAudioSessionProxy) alloc] initWithAudioSession:(AVAudioSession*)mockAVAudioSession]];
  RTCAudioSessionTestDelegate *delegate =
      [[RTCAudioSessionTestDelegate alloc] init];
  [session addDelegate:delegate];
