...
@property(copy, nullable) NSError *__nullable (^setCategoryModeBlock)(AVAudioSessionCategory category, AVAudioSessionMode mode, AVAudioSessionCategoryOptions options);
...
@property(copy, nullable) NSError *__nullable (^setModeBlock)(AVAudioSessionMode mode);
